...
-- Insert initial tickers (updated with real market data)
INSERT INTO tickers (symbol, last_price, change_24h, high_24h, low_24h, volume_24h, quote_volume_24h, open_price)
VALUES
  ('BTC/USDC', 97121.00, -6.43, 105000.00, 96000.00, 78188.45, 7818845307.93, 103797.00),
  ('ETH/USDC', 3340.00, -4.20, 3520.00, 3300.00, 156420.00, 540000000.00, 3486.00),
  ('BTC-PERP', 97123.00, -6.43, 105000.00, 96000.00, 85007.00, 8500700000.00, 103799.00),
  ('ETH-PERP', 3341.00, -4.18, 3522.00, 3302.00, 178500.00, 600000000.00, 3487.00)
ON DUPLICATE KEY UPDATE updated_at = CURRENT_TIMESTAMP;
